 ...
 */
public class RDSInstanceJanitor extends AbstractJanitor {
     ...
     */
    public RDSInstanceJanitor(AWSClient awsClient, AbstractJanitor.Context ctx) {
        super(ctx, AWSResourceType.RDS_INSTANCE);
    ...
    protected void cleanup(Resource resource) {
        LOGGER.info(String.format("Terminating RDS instance %s", resource.getId()));
        awsClient.deleteDBInstance(resource.getId());
    }
